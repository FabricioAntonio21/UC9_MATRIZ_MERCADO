...
Console.WriteLine("1 para COMPRAR | 2 para PESQUISAR");
...
switch(opcao) {
    ...
    continuar = Console.ReadLine();
        ...
        {
            Console.WriteLine("DESCRIÇÃO que deseja procurar?");
            ...
            for (linha = 0; linha <= 5; linha++)
            {
                ...
                {
                    Console.WriteLine("O produto: " + produtos[linha, 0] + "custa " + produtos[linha,3]);
                }
            }
            ...
            Console.WriteLine("Deseja pesquisar outro produto?");
